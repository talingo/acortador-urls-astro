...
const db = await createRemoteDatabaseClient(process.env.ASTRO_STUDIO_APP_TOKEN, {"BASE_URL": "/acortador", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://talingo.github.io", "ASSETS_PREFIX": undefined}.ASTRO_STUDIO_REMOTE_DB_URL ?? "https://db.services.astro.build");
